    ...
    */
    ...
    public function datasource(): Builder
    {
        return User::query()
            ...
            ->join('perusahaans', 'users.perusahaan_id', '=', 'perusahaans.id')
            ->select('users.*', 'roles.name as role', 'positions.name as position', 'perusahaans.name as perusahaan');
    }
    ...
    */
    public function addColumns(): PowerGridEloquent
    {
        return PowerGrid::eloquent()
            ...
            ->addColumn('perusahaan', function (User $model) {
                return ucfirst($model->perusahaan);
            })
    ...
    */
    ...
    public function columns(): array
    {
        return [
            ...
            Column::make('Username', 'username', 'users.username')
                ->searchable()
                ->makeInputText()
                ->editOnClick()
                ->sortable(),
            ...
            Column::make('Perusahaan', 'perusahaan', 'perusahaans.name')
                ->searchable()
                ->makeInputMultiSelect(Perusahaan::all(), 'name', 'perusahaan_id')
                ->sortable(),
