...
class AttendanceEditForm extends AttendanceAbstract
{
    ...
    public function mount()
    {
        ...
        $this->perusahaan_ids = $this->attendance->perusahaans()->pluck('perusahaans.id', 'perusahaans.id')->toArray();
    }
    ...
    public function save()
    {
        ...
        $this->perusahaan_ids = array_filter($this->perusahaan_ids, function ($id) {
            return is_numeric($id);
        });
        $position_ids = array_values($this->position_ids);
        $perusahaan_ids = array_values($this->perusahaan_ids);
        ...
        $this->attendance->perusahaans()->sync($perusahaan_ids);
